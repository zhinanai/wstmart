...
class Shops extends CShops{
    ...
    public function pageQuery($pagesize){
    	...
    	foreach ($page['Rows'] as $key =>$v){
    		...
    		$areaIds[] = isset($tmp[1])?$tmp[1]:'';
    		$page['Rows'][$key]['areaId'] = isset($tmp[1])?$tmp[1]:'';
    		//总评分
		...
		foreach ($page['Rows'] as $key =>$v){
			...
			$page['Rows'][$key]['areas']['areaName1'] = (isset($areaMap[$v['areaId']]))?$areaMap[$v['areaId']]['areaName1']:'';
            $page['Rows'][$key]['areas']['areaName2'] = (isset($areaMap[$v['areaId']]))?$areaMap[$v['areaId']]['areaName2']:'';
		}
    	return $page;
    }
    /**
